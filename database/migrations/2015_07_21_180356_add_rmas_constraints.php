...
class AddRmasConstraints extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('rmas', function($table){
            ...
            $table->integer('tiempo_rma_id')->unsigned();
            ...
            $table->foreign('tiempo_rma_id')->references('id')->on('rmas_tiempos');
    ...
    public function down()
    {
        ...
        Schema::table('rmas', function($table){
            ...
            $table->dropForeign('rmas_tiempo_rma_id_foreign');
            ...
            $table->dropColumn(['nota_credito_id', 'sucursal_id', 'tiempo_rma_id', 'empleado_id', 'cliente_id', 'estado_rma_id']);
        });
    }
}
