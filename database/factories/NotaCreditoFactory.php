...
$factory->defineAs(App\NotaCredito::class, 'full', function ($faker) use ($factory) {
    ...
    $nc['razon_social_emisor_id'] = factory(App\RazonSocialEmisor::class, 'full')->create()->id;
    $nc['razon_social_receptor_id'] = factory(App\RazonSocialReceptor::class, 'full')->create()->id;
