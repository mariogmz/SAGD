...
class PaqueteriaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['IM-AR', 'Enviar a sucursal Ags-Arboledas (2 a 4 días hábiles a partir del anticipo)', '', '', 'Se entrega en sucursal Arboledas de (2 a 4 días háibles a partir del anticipo)', 0],
