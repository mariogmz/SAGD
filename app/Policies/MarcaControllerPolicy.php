...
class MarcaControllerPolicy
{
    /**
     * Determinar si el usuario puede listar los Marcas
     *
     * @param  User  $user
     * @param  MarcaController $controller
     * @return bool
     */
    public function index(User $user, MarcaController $controller)
    {
    ...
    /**
     * Determinar si el usuario puede guardar un Marca
     *
     * @param  User  $user
     * @param  MarcaController $controller
     * @return bool
     */
    public function store(User $user, MarcaController $controller)
    {
        $controller = $this->normalizeControllerName($controller);
        $permisos = $user->morphable->permisos();
    ...
    /**
     * Determinar si el usuario puede ver un Marca
     *
     * @param  User  $user
     * @param  MarcaController $controller
     * @return bool
     */
    public function show(User $user, MarcaController $controller)
    {
        $controller = $this->normalizeControllerName($controller);
        $permisos = $user->morphable->permisos();
    ...
    /**
     * Determinar si el usuario puede actualizar un Marca
     *
     * @param  User  $user
     * @param  MarcaController $controller
     * @return bool
     */
    public function update(User $user, MarcaController $controller)
    {
        $controller = $this->normalizeControllerName($controller);
        $permisos = $user->morphable->permisos();
    ...
    /**
     * Determinar si el usuario puede eliminar un Marca
     *
     * @param  User  $user
     * @param  MarcaController $controller
     * @return bool
     */
    public function destroy(User $user, MarcaController $controller)
    {
        $controller = $this->normalizeControllerName($controller);
        $permisos = $user->morphable->permisos();
