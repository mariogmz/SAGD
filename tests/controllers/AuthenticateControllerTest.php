...
class AuthenticateControllerTest extends TestCase
{
    ...
    public function testVerificarPassword()
    {
        ...
        $payload = [
            'email' => 'admin@zegucom.com.mx',
            'password' => '123'
        ];

        JWTAuth::shouldReceive('attempt')->once()->withAnyArgs()->andReturn('wiu');
     ...
     * @group feature-transferencias
     */
    public function testVerificarPasswordSinParametrosCorrectos()
    {
        $endpoint = '/v1/password/verify';
        $payload = [];
     ...
     * @group feature-transferencias
     */
    public function testVerificarPasswordInvalido()
    {
        $endpoint = '/v1/password/verify';
        $payload = [
            'email' => 'admin@zegucom.com.mx',
