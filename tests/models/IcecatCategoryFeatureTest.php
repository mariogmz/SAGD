...
class IcecatCategoryFeatureTest extends TestCase {
    ...
    public function testIcecatIdEsRequerido() {
        $icecat_feature = factory(App\IcecatCategoryFeature::class)->make();
    ...
    public function testTypeEsMaximo45Caracteres() {
        $icecat_feature = factory(App\IcecatCategoryFeature::class, 'longtype')->make();
        $this->assertFalse($icecat_feature->isValid());
    ...
    public function testNameEsMaximo70Caracteres() {
        $icecat_feature = factory(App\IcecatCategoryFeature::class, 'longname')->make();
        $this->assertFalse($icecat_feature->isValid());
        $icecat_feature->name = 'Anthony Hoskins';
        $this->assertTrue($icecat_feature->isValid());
    }
    ...
    public function testDescriptionEsMaximo100Caracteres() {
        $icecat_feature = factory(App\IcecatCategoryFeature::class, 'longdescription')->make();
        $this->assertFalse($icecat_feature->isValid());
        $icecat_feature->description = 'Icecat Sucks';
        $this->assertTrue($icecat_feature->isValid());
    }
    ...
    public function testMeasureEsMaximo10Caracteres() {
        $icecat_feature = factory(App\IcecatCategoryFeature::class, 'longmeasure')->make();
        $this->assertFalse($icecat_feature->isValid());
